...
<Tabs items={["Example 1", "Example 2"]} storageKey="selected-pkg-manager" defaultIndex="0">
    ...
    <Tab>
    > Note: Try using the useActiveAuction hook for more data to build your Token Title!
      ```tsx copy
      import React from "react";
...
<Tabs items={["Example 1", "Example 2"]} storageKey="selected-pkg-manager" defaultIndex="0">
    ...
    <Tab>
       > Note: TokenThumbnail was used on the Flexible auction page within the TokenExplorer component, but you also use TokenThumbnail to represent an individual DAO member based on a specific token id. This is how you would set a profile picture for token #12
...
Displays a countdown timer until a given end time, in Unix timestamp format, by using the `useCountdown` hook. [View Source.](https://github.com/public-assembly/dao-utils/blob/main/packages/dao-utils/src/components/AuctionCountdown.tsx)
...
UI for proposal cards. [View Source.](https://github.com/public-assembly/dao-utils/blob/main/packages/dao-utils/src/components/ProposalPage.tsx)
...
Displays grid of proposal cards fetched from the Governor provider. [View Source.](https://github.com/public-assembly/dao-utils/blob/main/packages/dao-utils/src/components/ProposalCardGrid.tsx)
...
Displays ProposalTitle title using `useNounsProtocol` hook. [View Source.](https://github.com/public-assembly/dao-utils/blob/main/packages/dao-utils/src/components/ProposalTitle.tsx)
...
Displays ProposalDescription title using `useNounsProtocol` hook. [View Source.](https://github.com/public-assembly/dao-utils/blob/main/packages/dao-utils/src/components/ProposalDescription.tsx)
...
UI for voting on proposals. Displays proposal voting data by using the useVote hook. If proposal is active then voting is rendered. [View Source.](https://github.com/public-assembly/dao-utils/blob/main/packages/dao-utils/src/components/ProposalVoting.tsx)
...
Displays Vote Tally. [View Source.](https://github.com/public-assembly/dao-utils/blob/main/packages/dao-utils/src/components/VoteTally.tsx)
